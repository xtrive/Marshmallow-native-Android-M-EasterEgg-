...
public class MLandActivity extends Activity {
    ...
    private static final String TAG = "MLandActivity";

    public void test1(View view) {
        MLand mland = (MLand)findViewById(R.id.world);
        int playersSize = mland.playersSize();
        Log.d(TAG, "test1: playersSize = " + playersSize);

        mland.playersForEach (it-> Log.d(TAG, "test1: for-each " + it));
